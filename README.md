...
3. [Лабораторная работа 3 - Синхронизация потоков](#лабораторная-работа-3---синхронизация-потоков)
...
├── 📄 main_2/         # Папка с main_standard.cpp
...
[![БГУ](https://img.shields.io/badge/БГУ-blue)](https://bsu.by/)
[![ФПМИ](https://img.shields.io/badge/ФПМИ-orange)](https://fpmi.bsu.by/)
